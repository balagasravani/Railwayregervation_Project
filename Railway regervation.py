...
class train:
    def __init__(self,name = '', num = 0, arr_time = '',dep_time = '',src = '' ,des = '',day_of_travel = '',
                 seat_available_in_1AC = 0,seat_available_in_2AC = 0,seat_available_in_SL = 0,fare_1ac = 0, 
                 fare_2ac = 0 ,fare_sl = 0):
        self.name = name
        self.num = num
...
t1 = train('Ratnachal',12345,'12:34','22:12','bobbili','hyderabad','Wed',30,23,43,2205,320,234)
t2 = train('duronto express',12567,'02:34','20:12','vizag','vijayawada','Mon',33,4,12,3434,435,234)
t3 = train('Garib Rath',22353,'11:56','06:12','vijayawada','anakapalli','Fri',33,24,77,455,325,533)
trains = {t1.num:t1,t2.num:t2,t3.num:t3}
u1 = user(1111,'sri','cuttack','7478021777','sri')
